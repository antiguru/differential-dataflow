...
where
    ...
    T2: for<'a> Trace<Key<'a>=T1::Key<'a>, Time<'a>=T1::Time<'a>, TimeOwned=T1::TimeOwned> + 'static,
    V: Data,
    F: Fn(T2::Val<'_>) -> V + 'static,
    T2::Batch: Batch,
...
where
    C1: Cursor,
    C2: Cursor<Key<'a> = C1::Key<'a>, Time<'a> = C1::Time<'a>>,
    C3: Cursor<Key<'a> = C1::Key<'a>, Val<'a> = C1::Val<'a>, Time<'a> = C1::Time<'a>, Diff<'a> = C1::Diff<'a>>,
    V: Clone + Ord,
{
    fn new() -> Self;
    fn compute<F, L>(
...
mod history_replay {
    ...
    where
        C1: Cursor,
        C2: Cursor<Key<'a> = C1::Key<'a>, Time<'a> = C1::Time<'a>, TimeOwned=C1::TimeOwned>,
        C3: Cursor<Key<'a> = C1::Key<'a>, Val<'a> = C1::Val<'a>, Time<'a> = C1::Time<'a>, TimeOwned=C1::TimeOwned, Diff<'a> = C1::Diff<'a>>,
        V: Clone + Ord,
    {
    ...
    where
        C1: Cursor,
        C2: Cursor<Key<'a> = C1::Key<'a>, Time<'a> = C1::Time<'a>, TimeOwned=C1::TimeOwned>,
        C3: Cursor<Key<'a> = C1::Key<'a>, Val<'a> = C1::Val<'a>, Time<'a> = C1::Time<'a>, TimeOwned=C1::TimeOwned, Diff<'a> = C1::Diff<'a>, DiffOwned=C1::DiffOwned>,
        V: Clone + Ord,
    {
        fn new() -> Self {
            HistoryReplayer {
